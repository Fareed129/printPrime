  ...
  <header class="mkt-header">
    <nav class="mkt-navbar">
      ...
      <div class="mkt-nav-actions">
        <a href="<?= APP_URL ?>/download.php" class="btn-pp-outline d-none d-md-inline-flex" style="border-color: #1D4ED8; color: #1D4ED8; font-weight: 700; background-color: #EFF6FF;">
    ...
    <!-- Mobile Drawer Menu -->
    <div id="mobileNavMenu" style="display: none; flex-direction: column; background: #FFFDF8; border-bottom: 1px solid var(--pp-border); padding: 16px 24px; gap: 12px;">
      <a href="#product" class="mkt-nav-link py-1">Product Showcase</a>
      <a href="#how-it-works" class="mkt-nav-link py-1">How It Works</a>
      <a href="#for-shops" class="mkt-nav-link py-1">For Print Shops</a>
      <a href="#download" class="mkt-nav-link py-1 fw-bold text-primary"><i class="bi bi-download me-1"></i>Download Desktop Agent (.exe)</a>
      <a href="<?= APP_URL ?>/download.php" class="btn-pp-blue w-100 justify-content-center text-center py-2"><i class="bi bi-windows me-2"></i>Download for Windows</a>
      <a href="#architecture" class="mkt-nav-link py-1">Architecture</a>
      <a href="#faq" class="mkt-nav-link py-1">FAQ</a>
    </div>
  </header>
